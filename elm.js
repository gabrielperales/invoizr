...
var _user$project$Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {invoicer: a, customer: b, invoice: c, currentLine: d, currency: e, mdl: f};
	});
...
var _user$project$Types$SavePDF = {ctor: 'SavePDF'};
...
var _user$project$Views$addLineView = function (line) {
	var _p0 = line;
		...
		},
		{
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-12 b-none b-b-1px fs-1em ta-right'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$name('productName'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Product Name'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(line.product.name),
												_1: {
													ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Service price (€): '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$name('productPrice'),
											_1: {
												ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$name('productQty'),
												_1: {
													ctor: '::',
...
var _user$project$Views$editLineView = F2(
	function (mdl, _p3) {
		...
		var _p8 = _p4._0;
		var _p5 = _p9;
		var product = _p5.product;
		var quantity = _p5.quantity;
		var _p6 = product;
		var name = _p6.name;
		var price = _p6.price;
		var taxes = _p6.taxes;
					...
					case 'quantity':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{quantity: floatValue}));
					default:
						return A2(_user$project$Types$UpdateLine, _p8, _p9);
				}
			});
		return A2(
											...
											mdl,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onClick(
															_user$project$Types$ToggleEditLine(_p8)),
														_1: {ctor: '[]'}
													}
												}
											},
												...
												mdl,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																_user$project$Types$DeleteLine(_p8)),
															_1: {ctor: '[]'}
														}
													}
												},
...
var _user$project$Views$lineView = function (_p10) {
	var _p11 = _p10;
	var _p12 = _p11._1.product;
	var name = _p12.name;
	var price = _p12.price;
	var taxes = _p12.taxes;
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onDoubleClick(
					_user$project$Types$ToggleEditLine(_p11._0)),
				_1: {ctor: '[]'}
			}
		},
		{
					...
					_1: {
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(_p11._1.quantity)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Taxes'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Views$contactInfoView = function (_p13) {
	var _p14 = _p13;
	var _p15 = _p14.address;
	var inputText = function (val) {
		return A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('b-none fs-1em'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$type_('text'),
					_1: {
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Tax id: '),
						_1: {
							ctor: '::',
							_0: inputText(_p14.taxes_id),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
...
var _user$project$Views$invoiceHeader = function (_p16) {
	var _p17 = _p16;
	var _p18 = _p17.address;
	var inputText = F2(
		function (classes, val) {
			return A2(
				_elm_lang$html$Html$input,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], 'd-block bc-transparent b-none c-white fs-0-8em ', classes)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$type_('text'),
						_1: {
	...
	var inputBigger = inputText('fs-1em m-0 m-tb-0-75em p-0 ta-left');
	return A2(
		_elm_lang$html$Html$header,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-4 ta-right'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: inputDefault(_p17.phone),
						_1: {
							ctor: '::',
							_0: inputDefault(_p17.email),
							_1: {
								ctor: '::',
								_0: inputDefault(_p17.website),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: inputDefault(_p18.street),
							_1: {
								ctor: '::',
								_0: inputDefault(_p18.city),
								_1: {
									ctor: '::',
									_0: inputDefault(_p18.zip),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Views$toolbar = function (mdl) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Spanish'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Menu$onSelect(_user$project$Types$SavePDF),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Views$invoiceView = function (_p19) {
	var _p20 = _p19;
	var _p22 = _p20.mdl;
	var _p21 = _p20.invoice;
	var inputText = function (val) {
		return A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('b-none col-12 d-block fs-1em m-tb-1em'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$type_('text'),
					_1: {
	...
	var symbol = _user$project$InvoiceHelpers$currencySymb(_p20.currency);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Views$toolbar(_p22),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _user$project$Views$invoiceHeader(_p20.invoicer),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Billed to:'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _user$project$Views$contactInfoView(_p20.customer),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Invoice Number'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Date Of Issue'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Invoice total'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('ta-right fs-3em total'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString(
																			_user$project$InvoiceHelpers$total(_p21)),
																		symbol)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('fs-1-5em'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('PROJECT BREAKDOWN'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(_user$project$Views$invoiceLinesView, _p22, _p21),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Views$addLineView(_p20.currentLine),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(
																	_user$project$InvoiceHelpers$subtotal(_p21)),
																symbol))),
													_1: {ctor: '[]'}
												}),
											_1: {
														...
														_0: _elm_lang$html$Html$text(
															A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_elm_lang$core$Basics$toString(
																		_user$project$InvoiceHelpers$taxes(_p21)),
																	symbol))),
														_1: {ctor: '[]'}
													}),
												_1: {
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('fs-0-8em ta-justify'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('ta-center fs-0-6em'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
...
var _user$project$Ports$downloadPdf = _elm_lang$core$Native_Platform.outgoingPort(
	'downloadPdf',
	function (v) {
		return null;
	});
...
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'DeleteLine':
				var filter = function (_p1) {
					var _p2 = _p1;
					return _elm_lang$core$Native_Utils.eq(_p2._0, _p0._0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p2._1);
				};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'SavePDF':
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Ports$downloadPdf(
							{ctor: '_Tuple0'}),
						_1: {ctor: '[]'}
					});
			default:
...
var _user$project$App$model = {
	invoicer: _user$project$InvoiceHelpers$newContact,
