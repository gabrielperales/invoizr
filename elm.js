...
var _user$project$I18n$Total = {ctor: 'Total'};
var _user$project$I18n$Subtotal = {ctor: 'Subtotal'};
var _user$project$I18n$Delete = {ctor: 'Delete'};
var _user$project$I18n$Save = {ctor: 'Save'};
var _user$project$I18n$Amount = {ctor: 'Amount'};
var _user$project$I18n$Quantity = {ctor: 'Quantity'};
var _user$project$I18n$Taxes = {ctor: 'Taxes'};
var _user$project$I18n$Price = {ctor: 'Price'};
var _user$project$I18n$ServiceName = {ctor: 'ServiceName'};
var _user$project$I18n$ProjectBreakdown = {ctor: 'ProjectBreakdown'};
var _user$project$I18n$InvoiceTotal = {ctor: 'InvoiceTotal'};
var _user$project$I18n$DateOfIssue = {ctor: 'DateOfIssue'};
var _user$project$I18n$InvoiceNumber = {ctor: 'InvoiceNumber'};
var _user$project$I18n$ZipCode = {ctor: 'ZipCode'};
var _user$project$I18n$City = {ctor: 'City'};
var _user$project$I18n$Street = {ctor: 'Street'};
var _user$project$I18n$Address = {ctor: 'Address'};
var _user$project$I18n$TaxId = {ctor: 'TaxId'};
var _user$project$I18n$Name = {ctor: 'Name'};
var _user$project$I18n$BilledTo = {ctor: 'BilledTo'};
var _user$project$I18n$Invoice = {ctor: 'Invoice'};
...
var _user$project$Types$Address = F5(
	function (a, b, c, d, e) {
		return {street: a, city: b, state: c, country: d, zip: e};
	});
var _user$project$Types$Product = F3(
	function (a, b, c) {
		return {name: a, price: b, taxes: c};
	});
var _user$project$Types$Line = F3(
	function (a, b, c) {
		return {product: a, quantity: b, editing: c};
	});
...
var _user$project$Types$ToDatePicker = function (a) {
	return {ctor: 'ToDatePicker', _0: a};
};
var _user$project$Types$SetCurrency = function (a) {
	return {ctor: 'SetCurrency', _0: a};
};
var _user$project$Types$SetLanguage = function (a) {
	return {ctor: 'SetLanguage', _0: a};
};
var _user$project$Types$UpdateInvoicer = function (a) {
	return {ctor: 'UpdateInvoicer', _0: a};
};
var _user$project$Types$UpdateCurrentLine = function (a) {
	return {ctor: 'UpdateCurrentLine', _0: a};
};
var _user$project$Types$DeleteLine = function (a) {
	return {ctor: 'DeleteLine', _0: a};
};
var _user$project$Types$ToggleEditLine = function (a) {
	return {ctor: 'ToggleEditLine', _0: a};
};
var _user$project$Types$UpdateLine = F2(
	function (a, b) {
		return {ctor: 'UpdateLine', _0: a, _1: b};
	});
var _user$project$Types$AddLine = function (a) {
	return {ctor: 'AddLine', _0: a};
};

var _user$project$Helpers$toFixed = F2(
	function (decimals, number) {
		var join = _elm_lang$core$String$join('.');
		var parts = A2(
						...
						return join(
							{
								...
								_1: {
									ctor: '::',
									_0: zpadding(
										A2(_elm_lang$core$String$left, decimals, _p0._1._0)),
									_1: {ctor: '[]'}
								}
							});
					} else {
...
var _user$project$InvoiceHelpers$taxesLine = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.product;
	return A2(
		F2(
...
var _user$project$InvoiceHelpers$taxes = function (_p3) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
		...
		0,
		A2(_elm_lang$core$List$map, _user$project$InvoiceHelpers$taxesLine, _p3));
};
var _user$project$InvoiceHelpers$subtotalLine = function (_p4) {
	var _p5 = _p4;
	return A2(
		F2(
			function (x, y) {
...
var _user$project$InvoiceHelpers$totalLine = function (line) {
	return A2(
		F2(
			function (x, y) {
				return x + y;
			}),
		_user$project$InvoiceHelpers$subtotalLine(line),
		_user$project$InvoiceHelpers$taxesLine(line));
};
var _user$project$InvoiceHelpers$total = function (_p6) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
		...
		0,
		A2(_elm_lang$core$List$map, _user$project$InvoiceHelpers$totalLine, _p6));
};
var _user$project$InvoiceHelpers$subtotal = function (_p7) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _user$project$InvoiceHelpers$updateLineQuantity = F2(
	function (cty, line) {
		return (_elm_lang$core$Native_Utils.cmp(cty, 0) < 0) ? _elm_lang$core$Native_Utils.update(
			line,
			{quantity: 0}) : _elm_lang$core$Native_Utils.update(
			line,
			{quantity: cty});
	});
var _user$project$InvoiceHelpers$addQuantity = F2(
	function (qty, line) {
		return A2(
			_user$project$InvoiceHelpers$updateLineQuantity,
			A2(
				F2(
					function (x, y) {
						return x + y;
...
var _user$project$InvoiceHelpers$addProduct = _user$project$InvoiceHelpers$addQuantity(1);
var _user$project$InvoiceHelpers$removeQuantity = F2(
	function (qty, line) {
		return A2(
			_user$project$InvoiceHelpers$updateLineQuantity,
			A2(
...
var _user$project$InvoiceHelpers$removeProduct = _user$project$InvoiceHelpers$removeQuantity(1);
var _user$project$InvoiceHelpers$addLine = F2(
	function (x, y) {
		return {ctor: '::', _0: x, _1: y};
	});
var _user$project$InvoiceHelpers$exampleContact = A6(
	_user$project$Types$ContactDetails,
	'Sherlock & associates',
	'',
	'+34 600 123 123',
	'sherlock@holmes.co.uk',
	'astudyinpink.com',
	A5(_user$project$Types$Address, 'Baker St 221B', 'London', '', 'UK', 'NW1 6XE'));
var _user$project$InvoiceHelpers$newContact = A6(
	_user$project$Types$ContactDetails,
	'',
	'',
	'',
	'',
	'',
	A5(_user$project$Types$Address, '', '', '', '', ''));
var _user$project$InvoiceHelpers$newEmptyLine = A3(
	_user$project$Types$Line,
...
var _user$project$Views$addLineView = F3(
	function (language, currency, line) {
		var _p0 = line;
		var quantity = _p0.quantity;
		var _p1 = line;
		var product = _p1.product;
		var updateField = F2(
			function (field, value) {
				...
				switch (_p2) {
					case 'name':
						return _user$project$Types$UpdateCurrentLine(
							_elm_lang$core$Native_Utils.update(
								line,
								{
									product: _elm_lang$core$Native_Utils.update(
										product,
										{name: value})
								}));
					case 'price':
					...
					case 'quantity':
						return _user$project$Types$UpdateCurrentLine(
							_elm_lang$core$Native_Utils.update(
								...
								{quantity: floatValue}));
					default:
						return _user$project$Types$UpdateCurrentLine(line);
				}
			});
		var inputGroup = F3(
			function (_p3, translateId, val) {
				var _p4 = _p3;
				return A2(
					_elm_lang$html$Html$label,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-sm-12 col-3'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(_user$project$I18n$translate, language, translateId),
								': ')),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-sm-12 col-12 b-none b-b-1px h4 ta-right'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_(_p4._1),
										_1: {
											ctor: '::',
		...
		return A2(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onSubmit(
							_user$project$Types$AddLine(line)),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				...
				_0: A3(
					inputGroup,
					{ctor: '_Tuple2', _0: 'name', _1: 'text'},
					_user$project$I18n$ServiceName,
					line.product.name),
				_1: {
					ctor: '::',
					_0: A3(
						inputGroup,
						{ctor: '_Tuple2', _0: 'price', _1: 'number'},
						_user$project$I18n$Price,
						_elm_lang$core$Basics$toString(line.product.price)),
					_1: {
						ctor: '::',
						_0: A3(
							inputGroup,
							{ctor: '_Tuple2', _0: 'taxes', _1: 'number'},
							_user$project$I18n$Taxes,
							_elm_lang$core$Basics$toString(line.product.taxes)),
						_1: {
							ctor: '::',
							_0: A3(
								inputGroup,
								{ctor: '_Tuple2', _0: 'quantity', _1: 'number'},
								_user$project$I18n$Quantity,
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value('Add line'),
											_1: {
												ctor: '::',
...
var _user$project$Views$editLineView = F2(
	function (language, _p5) {
		var _p6 = _p5;
		var _p11 = _p6._1;
		var _p10 = _p6._0;
		var _p7 = _p11;
		var product = _p7.product;
		var quantity = _p7.quantity;
		var _p8 = product;
		var name = _p8.name;
		var price = _p8.price;
		var taxes = _p8.taxes;
		var updateField = F2(
			function (field, value) {
				...
				switch (_p9) {
					case 'name':
						return A2(
							_user$project$Types$UpdateLine,
							_p10,
							_elm_lang$core$Native_Utils.update(
								_p11,
								{
					...
					case 'quantity':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{quantity: floatValue}));
					default:
						return A2(_user$project$Types$UpdateLine, _p10, _p11);
				}
			});
		return A2(
			_elm_lang$html$Html$tr,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('row col-12'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-3 p-0 ta-right'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-12 ta-right'),
								_1: {
									ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-2 p-0 ta-right'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(
													_elm_lang$core$Basics$toString(taxes)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(
														updateField('taxes')),
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Types$ToggleEditLine(_p10)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(_user$project$I18n$translate, language, _user$project$I18n$Save)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$button,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Types$DeleteLine(_p10)),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														A2(_user$project$I18n$translate, language, _user$project$I18n$Delete)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$Views$lineView = function (_p12) {
	var _p13 = _p12;
	var _p16 = _p13._1;
	var _p14 = _p16;
	var product = _p14.product;
	var quantity = _p14.quantity;
	var _p15 = product;
	var name = _p15.name;
	var price = _p15.price;
	var taxes = _p15.taxes;
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onDoubleClick(
					_user$project$Types$ToggleEditLine(_p13._0)),
				_1: {ctor: '[]'}
			}
		},
		{
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(
											_user$project$InvoiceHelpers$subtotalLine(_p16))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Views$invoiceLinesView = F2(
	function (language, invoiceLines) {
		var view = F2(
			function (index, line) {
				return line.editing ? A2(
					_user$project$Views$editLineView,
					language,
					{ctor: '_Tuple2', _0: index, _1: line}) : _user$project$Views$lineView(
					{ctor: '_Tuple2', _0: index, _1: line});
			});
		var tableBody = A2(_elm_lang$core$List$indexedMap, view, invoiceLines);
		var tableHead = A2(
			_elm_lang$html$Html$tr,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_user$project$I18n$translate, language, _user$project$I18n$ServiceName)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_user$project$I18n$translate, language, _user$project$I18n$Price)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_user$project$I18n$translate, language, _user$project$I18n$Quantity)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_user$project$I18n$translate, language, _user$project$I18n$Amount)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		var invoiceTable = {ctor: '::', _0: tableHead, _1: tableBody};
		return A2(
			_elm_lang$html$Html$table,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('col-12 m-b-2em'),
				_1: {ctor: '[]'}
			},
			invoiceTable);
	});
var _user$project$Views$contactInfoView = F2(
	function (language, _p17) {
		var _p18 = _p17;
		var _p21 = _p18.address;
		var inputText = F2(
			function (pholder, val) {
				return A2(
					_elm_lang$html$Html$input,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('b-none m-b-0-5em'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$type_('text'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder(pholder),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(val),
									_1: {ctor: '[]'}
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('m-b-0-5em'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(_user$project$I18n$translate, language, _user$project$I18n$Name),
								' :')),
						_1: {
							ctor: '::',
							_0: A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_user$project$I18n$translate, language, _user$project$I18n$TaxId),
									': ')),
							_1: {
								ctor: '::',
								_0: A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_user$project$I18n$translate, language, _user$project$I18n$Address),
										': ')),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('p-lr-1em'),
									_1: {ctor: '[]'}
								},
								A2(
									...
									A2(
										...
										function (_p19) {
											...
											return A2(
												inputText,
												A2(_user$project$I18n$translate, language, _p20._1),
												_p20._0);
										},
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: _p21.street, _1: _user$project$I18n$Street},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: _p21.city, _1: _user$project$I18n$City},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: _p21.zip, _1: _user$project$I18n$ZipCode},
													_1: {ctor: '[]'}
												}
											}
										}))),
...
var _user$project$Views$invoiceHeader = F2(
	function (language, invoicer) {
		var inputText = F3(
			function (classes, val, change) {
				return A2(
					_elm_lang$html$Html$input,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(
							A2(_elm_lang$core$Basics_ops['++'], 'd-block col-12 bc-transparent b-none c-white p ', classes)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$type_('text'),
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(change),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		var inputDefault = inputText('m-1em');
		var inputBigger = inputText('h4 m-0 m-tb-0-75em p-0 ta-left');
		var _p22 = invoicer;
		var name = _p22.name;
		var taxes_id = _p22.taxes_id;
		var phone = _p22.phone;
		var email = _p22.email;
		var website = _p22.website;
		var address = _p22.address;
		return A2(
			_elm_lang$html$Html$header,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('row header p-tb-1-5em p-lr-3em'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							name,
							function (value) {
								return _user$project$Types$UpdateInvoicer(
									_elm_lang$core$Native_Utils.update(
										invoicer,
										{name: value}));
							}),
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_user$project$I18n$translate, language, _user$project$I18n$Invoice)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-sm-6 col-4 ta-right'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									function (value) {
										return _user$project$Types$UpdateInvoicer(
											_elm_lang$core$Native_Utils.update(
												invoicer,
												{
													address: _elm_lang$core$Native_Utils.update(
														address,
														{street: value})
												}));
									}),
...
var _user$project$Views$invoiceView = function (model) {
	var inputText = function (val) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('b-none col-12 d-block h4 m-tb-1em'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$type_('text'),
					_1: {
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('invoice'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('row p-lr-3em p-tb-1-5em'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('col-4 h5'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
												...
												},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('ta-right h1 total'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('m-lr-3em b-none b-b-1px'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('p-lr-3em p-b-1em'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('p-lr-3em p-b-1em no-print'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('p-lr-3em'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('p-lr-3em ta-right'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('footer p-1em p-lr-3em'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('h6 ta-justify'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('IMPORTANT: The above invoice may be paid by Bank Transfer.\n                      Payment is due within 30 days from the date of this invoice, late payment is subject to a fee of 5% per month.'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('ta-center copyright h6'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Gabriel Perales ® 2017'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
...
var _user$project$Ports$print = _elm_lang$core$Native_Platform.outgoingPort(
	'print',
	function (v) {
		return null;
	});
var _user$project$Ports$saveInvoicerDetails = _elm_lang$core$Native_Platform.outgoingPort(
	'saveInvoicerDetails',
	function (v) {
		return v;
	});
...
var _user$project$ContactDetails$decode = function (invoicer) {
	...
	return A2(
		...
		A7(
			...
			_user$project$Types$ContactDetails,
			A2(_elm_lang$core$Json_Decode$field, 'name', string),
			A2(_elm_lang$core$Json_Decode$field, 'taxes_id', string),
			A2(_elm_lang$core$Json_Decode$field, 'phone', string),
			A2(_elm_lang$core$Json_Decode$field, 'email', string),
			A2(_elm_lang$core$Json_Decode$field, 'website', string),
			A2(
				_elm_lang$core$Json_Decode$field,
				'address',
				A6(
					_elm_lang$core$Json_Decode$map5,
					_user$project$Types$Address,
					A2(_elm_lang$core$Json_Decode$field, 'street', string),
					A2(_elm_lang$core$Json_Decode$field, 'city', string),
					A2(_elm_lang$core$Json_Decode$field, 'state', string),
					A2(_elm_lang$core$Json_Decode$field, 'country', string),
					A2(_elm_lang$core$Json_Decode$field, 'zip', string)))),
		invoicer);
};
var _user$project$ContactDetails$encode = function (details) {
	var string = _elm_lang$core$Json_Encode$string;
	return A2(
										...
										_1: _elm_lang$core$Json_Encode$object(
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'street',
													_1: string(details.address.street)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'city',
														_1: string(details.address.city)
													},
													_1: {
														ctor: '::',
														_0: {
															ctor: '_Tuple2',
															_0: 'state',
															_1: string(details.address.state)
														},
														_1: {
															ctor: '::',
															_0: {
																ctor: '_Tuple2',
																_0: 'country',
																_1: string(details.address.country)
															},
															_1: {
																ctor: '::',
																_0: {
...
var _user$project$DatePickerHelpers$monthToInt = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 1;
...
var _user$project$DatePickerHelpers$formatDate = function (date) {
	return A2(
		_elm_lang$core$String$join,
		'/',
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$core$Date$day(date),
				_1: {
					ctor: '::',
					_0: _user$project$DatePickerHelpers$monthToInt(
						_elm_lang$core$Date$month(date)),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Date$year(date),
...
var _user$project$DatePickerHelpers$newDatePicker = function (mdate) {
	return _elm_lang$core$Tuple$first(
		_elm_community$elm_datepicker$DatePicker$init(
			_elm_lang$core$Native_Utils.update(
				_elm_community$elm_datepicker$DatePicker$defaultSettings,
				{firstDayOfWeek: _elm_lang$core$Date$Mon, pickedDate: mdate, dateFormatter: _user$project$DatePickerHelpers$formatDate})));
};
		...
		switch (_p0.ctor) {
			case 'AddLine':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							invoice: {ctor: '::', _0: _p0._0, _1: model.invoice},
			...
			case 'UpdateInvoicer':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Ports$saveInvoicerDetails(
							_user$project$ContactDetails$encode(_p1)),
						_1: {ctor: '[]'}
					});
			case 'ToggleEditLine':
				var update = F2(
					function (idx, item) {
						return _elm_lang$core$Native_Utils.eq(idx, _p0._0) ? _elm_lang$core$Native_Utils.update(
							item,
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							invoice: A2(_elm_lang$core$List$indexedMap, update, model.invoice)
						}),
					{
						ctor: '::',
						_0: _elm_lang$core$Platform_Cmd$none,
			...
			case 'UpdateLine':
				var update = F2(
					function (idx, item) {
						return _elm_lang$core$Native_Utils.eq(idx, _p0._0) ? _p0._1 : item;
					});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'DeleteLine':
				var filter = function (_p2) {
					var _p3 = _p2;
					return _elm_lang$core$Native_Utils.eq(_p3._0, _p0._0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p3._1);
				};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'ToDatePicker':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$ToDatePicker, datePickerFx),
						_1: {ctor: '[]'}
					});
			case 'SetDate':
				var _p8 = _p0._0;
...
var _user$project$App$model = {
	invoicer: _user$project$InvoiceHelpers$exampleContact,
	customer: _user$project$InvoiceHelpers$newContact,
	invoice: {ctor: '[]'},
...
var _user$project$App$main = _elm_lang$html$Html$programWithFlags(
	{
		...
		view: _user$project$Views$invoiceView,
